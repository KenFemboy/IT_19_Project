        ...
        {items.map((toast) => {
          ...
          return (
            <motion.div
              ...
              exit={{ opacity: 0, y: -16 }}
              className="glass-card flex items-start gap-3 p-4 text-sm text-slate-700 shadow-soft"
            >
              <span className="mt-1 rounded-full bg-emerald-100 p-2 text-emerald-700">
